...
$english = array(
 ...
 'questions:form:access' => "Access", 'questions:form:answer' => "Answer",
	'questions:form:question' => "Question", 'questions:form:tags' => "Tags (comma separated)",
	'questions:form:title' => "Title", 'questions:form:user:admin' => "Administrator",
	'questions:form:user:common' => "Registered User",
	'questions:form:whoanswers' => "Who can answer?", /**
	 * Menu & Submenu
	 */

 'questions:menu:home' => "Questions", 'questions:submenu:allquestions' => "All The Questions",
	'questions:submenu:answered' => "Answered Questions", 'questions:submenu:home' => "Questions",
 ...
 'questions:body:answer' => "Answer Question", 'questions:body:deleteanswer' => "Delete Answer",
	...
	'questions:body:editanswer' => "Edit Answer", 'questions:body:editquestion' => "Edit Question",
	...
	'questions:body:rate:no' => "No (%s)", 'questions:body:rate:yes' => "Yes (%s)",
	'questions:body:submittedby' => 'Submitted %s by %s',
	'questions:body:viewanswers' => "View Answers (%s)", /**
	 * Ordering
	 */

 'questions:ordering:asc' => 'Ascendent', 'questions:ordering:desc' => 'Descendent',
	'questions:ordering:helpful' => 'Helpful', 'questions:ordering:interesting' => 'Interesting',
	'questions:ordering:num_of_answers' => '# Answers',
	'questions:ordering:time_created' => 'Created', 'questions:ordering:username' => 'Username', /**
	 * Actions
	 */
 ...
 'questions:viewanswers:question' => "Question", 'questions:viewanswers:answers' => "Answers", /**
	 * Rate
	 */
...
To see the answer from the web, please click in the next link: %s", /**
 ...
 'item:object:answer' => "Answers", 'item:object:question' => "Questions",);
